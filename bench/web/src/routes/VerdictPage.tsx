  ...
  return (
    <div className="page doc">
      ...
      <footer className="doc-foot">
        Every rate on this page carries the number of scenes it was measured over and its 95%
        interval, and every comparison is paired on the scenes the arms both ran. Sections marked
        “not comparable” are rungs one arm never measured — that is an absence of measurement, not
        a score of zero. Generated by Gantry Bench for {data.benchmark?.name}; submission{" "}
